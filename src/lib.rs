...
fn contact_icons() -> Markup {
    ...
    html! {
        a href="https://github.com/futile" target="_blank" title="My GitHub Profile" {
        ...
        a href="https://www.linkedin.com/in/felix-rath/" target="_blank" title="My LinkedIn Profile" {
        ...
        a href="https://mas.to/@frath" target="_blank" title="My mastodon Profile" {
        ...
        a href="mailto:felixm.rath@gmail.com" target="_blank" title="My Email Address" {
